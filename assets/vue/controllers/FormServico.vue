      ...
      <div class="col-12">
        ...
        <div class="file-upload-wrapper mt-2">
          <label class="file-upload-label m-0 cursor-pointer w-100">
            ...
            <!-- Garantindo o "[]" no final para ser enviado como Array pro PHP -->
            <input type="file" :name="fieldNames.foto + (fieldNames.foto.endsWith('[]') ? '' : '[]')" multiple @change="handleFileChange" class="d-none" accept="image/*">
          </label>
        </div>
      </div>
    </div>
